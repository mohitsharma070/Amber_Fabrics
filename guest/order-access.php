...
<section class="page-hero"><div class="l-container"><h1>Manage Your Order</h1><p class="u-mb-0">Get a secure link by email.</p></div></section>
<section class="section-block"><div class="l-container"><div class="surface-panel u-p-4 u-mx-auto auth-card"><?php if($sent): ?><div class="ui-alert ui-alert--success">If those details match an order, a secure link has been sent.</div><?php endif; ?><form method="post"><?php echo csrf_field(); ?><div class="u-mb-3"><label for="order_number" class="ui-label">Order number</label><input id="order_number" class="ui-input" name="order_number" required></div><div class="u-mb-3"><label for="email" class="ui-label">Order email</label><input id="email" class="ui-input" type="email" name="email" required></div><button class="ui-button ui-button--primary u-w-full">Email Secure Link</button></form></div></div></section><?php include __DIR__.'/../includes/footer.php'; ?>
