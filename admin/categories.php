...
<div class="ui-card u-mb-4">
    <div class="ui-card__body">
        ...
        <form method="post" class="l-grid l-grid--12 u-gap-3 admin-filter-form" enctype="multipart/form-data">
            ...
            <div class="l-col-md-two">
                <label for="default_unit_type_create" class="ui-label">Required Unit</label>
                <select id="default_unit_type_create" name="default_unit_type" class="ui-select">
...
<div class="ui-table-wrap">
    <table class="ui-table ui-table--striped u-align-middle admin-no-card-table">
        ...
        <?php if (empty($categories)): ?>
            <tr><td colspan="8" class="u-text-center u-text-muted u-py-4">No categories found.</td></tr>
        <?php else: ?>
                    ...
                    <td>
                        <details>
                            ...
                            <form method="post" class="l-grid l-grid--12 u-gap-2 u-mt-2" enctype="multipart/form-data">
                                ...
                                <div class="l-col-md-two">
                                    <select name="default_unit_type" class="ui-select ui-select--small" aria-label="Required selling unit">
