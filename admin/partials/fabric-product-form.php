...
<form method="POST" class="row g-3" id="product-editor-form" data-initial-editor-section="<?php echo e($initialEditorSection); ?>" data-initial-editor-target="<?php echo e($initialEditorTarget); ?>">
 ...
 <div class="col-md-3" data-editor-section="pricing"><label for="qty_step" class="form-label">Quantity Step</label><input id="qty_step" type="number" name="qty_step" min="0.0001" step="0.0001" class="<?php echo form_class($errors,'qty_step');?>" value="<?php echo e((string)($old['qty_step']??''));?>" placeholder="e.g. 0.125"><div class="form-text">Meter steps support up to four decimal places; piece/set steps must be whole numbers.</div><?php echo form_error($errors,'qty_step');?></div>
