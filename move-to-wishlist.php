...
if (isset($_SESSION['cart'][$productId])) {
    ...
    if (isset($_SESSION['cart_size'][$productId])) {
        $_SESSION['wishlist_size'][$productId] = $_SESSION['cart_size'][$productId];
        unset($_SESSION['cart_size'][$productId]);
    }
    if (isset($_SESSION['cart_meter_length'][$productId])) {
        $_SESSION['wishlist_meter_length'][$productId] = $_SESSION['cart_meter_length'][$productId];
    ...
    flash('success', 'Item moved to wishlist.');
} else {
