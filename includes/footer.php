    ...
    <div class="container">
        <div class="footer-desktop d-none d-md-grid">
            ...
            <div>
                ...
                <p><a class="text-decoration-none text-light" href="/contact"><?php echo e($footerSupportCta); ?></a></p>
            </div>
            <div>
                <h5><?php echo e($footerExploreTitle); ?></h5>
                <p><a class="text-decoration-none text-light" href="/catalog"><?php echo e($footerExploreShop); ?></a></p>
                <p><a class="text-decoration-none text-light" href="/#catSlider"><?php echo e($footerExploreCategories); ?></a></p>
                <p><a class="text-decoration-none text-light" href="/international-buyers"><?php echo e($footerExploreInquiry); ?></a></p>
                <p><a class="text-decoration-none text-light" href="/faq"><?php echo e($footerExploreFaq); ?></a></p>
            </div>
            <div>
                <h5><?php echo e($footerPoliciesTitle); ?></h5>
                <p><a class="text-decoration-none text-light" href="/shipping-policy"><?php echo e($footerPolicyShipping); ?></a></p>
                <p><a class="text-decoration-none text-light" href="/return-policy"><?php echo e($footerPolicyReturn); ?></a></p>
                <p><a class="text-decoration-none text-light" href="/privacy-policy"><?php echo e($footerPolicyPrivacy); ?></a></p>
                <p><a class="text-decoration-none text-light" href="/terms"><?php echo e($footerPolicyTerms); ?></a></p>
                <p><a class="text-decoration-none text-light" href="/size-guide"><?php echo e($footerPolicySizeGuide); ?></a></p>
                <p><a class="text-decoration-none text-light" href="/international-orders-policy"><?php echo e($footerPolicyInternational); ?></a></p>
            </div>
        </div>
            ...
            <div class="accordion footer-accordion" id="footerAccordion">
                <div class="accordion-item">
                    ...
                    <div id="footerSupport" class="accordion-collapse collapse" data-bs-parent="#footerAccordion">
                        <div class="accordion-body">
                            ...
                            <a href="/contact"><?php echo e($footerSupportCta); ?></a>
                ...
                <div class="accordion-item">
                    ...
                    <div id="footerExplore" class="accordion-collapse collapse" data-bs-parent="#footerAccordion">
                        <div class="accordion-body">
                            <a href="/catalog"><?php echo e($footerExploreShop); ?></a>
                            <a href="/#catSlider"><?php echo e($footerExploreCategories); ?></a>
                            <a href="/international-buyers"><?php echo e($footerExploreInquiry); ?></a>
                            <a href="/faq"><?php echo e($footerExploreFaq); ?></a>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="footerPolicies" class="accordion-collapse collapse" data-bs-parent="#footerAccordion">
                        <div class="accordion-body">
                            <a href="/shipping-policy"><?php echo e($footerPolicyShipping); ?></a>
                            <a href="/return-policy"><?php echo e($footerPolicyReturn); ?></a>
                            <a href="/privacy-policy"><?php echo e($footerPolicyPrivacy); ?></a>
                            <a href="/terms"><?php echo e($footerPolicyTerms); ?></a>
                            <a href="/size-guide"><?php echo e($footerPolicySizeGuide); ?></a>
...
<?php
$showMobileBottomNav = !in_array($currentPage ?? '', ['login.php'], true);
?>
