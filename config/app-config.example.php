...
return [
    'local' => [
        ...
        // Bigship Direct: use only non-production test values locally.
        'BIGSHIP_BASE_URL' => '',
        'BIGSHIP_USERNAME' => '',
        'BIGSHIP_PASSWORD' => '',
        'BIGSHIP_ACCESS_KEY' => '',
        ...
        // Local troubleshooting only. Keep 0 unless your local CA chain is broken.
    ...
    'production' => [
        ...
        'SHIPPING_RTO_RISK_HIGH_THRESHOLD' => '70',
        'SHIPPING_RTO_RISK_MEDIUM_THRESHOLD' => '40',
        // Set secrets only through server environment variables or external secure-config.php.
        'BIGSHIP_BASE_URL' => '',
        'BIGSHIP_USERNAME' => '',
        'BIGSHIP_PASSWORD' => '',
        'BIGSHIP_ACCESS_KEY' => '',
