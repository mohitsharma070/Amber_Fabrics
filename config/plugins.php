...
return [
    ...
    'settings' => [
        ...
        'shipping-courier' => [
            ...
            'bigship_warehouse_segment' => function_exists('_cfg') ? _cfg('BIGSHIP_WAREHOUSE_SEGMENT', 'local') : 'local',
            ...
            'bigship_invoice_type' => function_exists('_cfg') ? _cfg('BIGSHIP_INVOICE_TYPE', '') : '',
            ...
            'bigship_parcel_width_cm' => function_exists('_cfg') ? _cfg('BIGSHIP_PARCEL_WIDTH_CM', '') : '',
            'bigship_parcel_height_cm' => function_exists('_cfg') ? _cfg('BIGSHIP_PARCEL_HEIGHT_CM', '') : '',
            'bigship_packaging_weight_kg' => function_exists('_cfg') ? _cfg('BIGSHIP_PACKAGING_WEIGHT_KG', '0.10') : '0.10',
            'bigship_weight_per_meter_kg' => function_exists('_cfg') ? _cfg('BIGSHIP_WEIGHT_PER_METER_KG', '0.25') : '0.25',
            'bigship_weight_per_piece_kg' => function_exists('_cfg') ? _cfg('BIGSHIP_WEIGHT_PER_PIECE_KG', '0.35') : '0.35',
            'bigship_weight_per_set_kg' => function_exists('_cfg') ? _cfg('BIGSHIP_WEIGHT_PER_SET_KG', '0.75') : '0.75',
            'bigship_parcel_height_per_unit_cm' => function_exists('_cfg') ? _cfg('BIGSHIP_PARCEL_HEIGHT_PER_UNIT_CM', '1.5') : '1.5',
            'bigship_parcel_max_height_cm' => function_exists('_cfg') ? _cfg('BIGSHIP_PARCEL_MAX_HEIGHT_CM', '60') : '60',
        ],
        'review-rating' => [
