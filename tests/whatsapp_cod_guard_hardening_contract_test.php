...
$assert(str_contains($commerce, 'checkoutTotal >= Number(config.codWhatsappThreshold || 0)') && str_contains($commerce, 'function whatsappRequired()') && str_contains($commerce, 'whatsappValid'), 'Checkout JavaScript must require consent only when the COD amount selects message confirmation.');
