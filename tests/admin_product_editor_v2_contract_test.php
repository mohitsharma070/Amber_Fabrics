...
$assert(!str_contains($editor,"\$errors['meter_options']")&&!str_contains($editor,'meter_options = ?')&&!str_contains($editorScript,'meterOptionsInput'),'Retired meter options must not be validated, saved, or handled by the editor.');
