...
<section class="page-hero">
    <div class="l-container">
        <h1>Checkout</h1>
        <p class="u-mb-0">Cash on Delivery and Razorpay online payment available</p>
    </div>
</section>
...
<section class="section-block">
    <div class="l-container">
        <?php if (!empty($errors['_cart'])): ?>
            <div class="ui-alert ui-alert--error"><?php echo e($errors['_cart']); ?></div>
        <?php endif; ?>
        <?php if (!$isIndia): ?>
            <div class="ui-alert ui-alert--warning">
                International checkout is inquiry-only for now. Please use
                <a href="/international-buyers.php" class="ui-alert__link">Request International Quote</a>.
            </div>
        <?php endif; ?>

        <div class="l-grid l-grid--12 u-gap-4 checkout-layout">
            <div class="l-col-lg-seven u-order-first checkout-form-column">
                <form
                    id="checkout_form"
                    method="POST"
                    ...
                    data-ui-checkout
                    data-checkout-config="<?php echo ui_data_json([
                        'subtotal' => (float) $subtotal,
                        ...
                        'shippingDebugMessage' => (($GLOBALS['_app_mode'] ?? '') === 'local') ? (string) ($shippingQuote['debug_message'] ?? '') : '',
                ...
                >
                    ...
                    <div class="surface-panel u-p-4 u-mb-4 checkout-section" id="checkout_section_address">
                        <div class="u-flex u-justify-between u-items-start u-gap-2 u-mb-2">
                            <div>
                                <div class="u-text-small u-text-muted">Step 1 of 3: Delivery</div>
                                <h5 class="u-mb-0">Delivery Details</h5>
                            </div>
                            <button type="button" class="ui-button ui-button--secondary ui-button--small u-hidden" id="checkout_edit_address">Edit</button>
                        </div>
                        <div class="checkout-section-summary u-hidden" id="checkout_address_summary"></div>
                        <div class="checkout-section-body" id="checkout_address_body">
                        <?php if ($customerId <= 0): ?>
                            <div class="ui-alert ui-alert--neutral u-border u-py-2 u-px-3 u-text-small u-mb-3">
                            ...
                            <?php if ($customerId <= 0): ?>
                                <div class="l-col-full">
                                    <div class="ui-check u-mb-2">
                                        <input class="ui-check__input" type="checkbox" value="1" id="create_account" name="create_account" <?php echo !empty($old['create_account']) ? 'checked' : ''; ?>>
                                        <label class="ui-check__label" for="create_account">
                                            Email me an account activation link after ordering
                                        </label>
                                    </div>
                                    <div class="u-text-small u-text-muted">You will choose a password from a secure email link after checkout.</div>
                                </div>
                            <?php endif; ?>
                            <div class="l-col-full">
                    ...
                    <div class="surface-panel u-p-4 u-mb-4 checkout-section<?php echo $hasCompleteDelivery ? '' : ' u-hidden'; ?>" id="checkout_section_payment" aria-hidden="<?php echo $hasCompleteDelivery ? 'false' : 'true'; ?>">
                        <div class="u-flex u-justify-between u-items-start u-gap-2 u-mb-2">
                            <div>
                                <div class="u-text-small u-text-muted">Step 2 of 3: Payment</div>
                                <h5 class="u-mb-0">Payment Method</h5>
                            </div>
                            <button type="button" class="ui-button ui-button--secondary ui-button--small u-hidden" id="checkout_edit_payment">Edit</button>
                        </div>
                        <div class="checkout-section-summary u-hidden" id="checkout_payment_summary"></div>
                        ...
                        <div class="checkout-payment-options">
                            <label class="checkout-pay-option" for="payment_cod" data-pay-option="cod">
                                <span class="checkout-pay-main">
                                    <input class="ui-check__input u-mt-0" type="radio" name="payment_method" id="payment_cod" value="cod" <?php echo ($old['payment_method'] ?? 'cod') === 'cod' ? 'checked' : ''; ?>>
                                    <span>
                                        <strong>Cash on Delivery (COD)</strong>
                                        <small class="u-block u-text-muted">Pay in cash when your order is delivered.</small>
                                    </span>
                                </span>
                            </label>
                            <div class="checkout-pay-panel" id="cod-panel">
                                ...
                                <?php if ($codWhatsappConsentAvailable): ?>
                                    <div class="ui-check u-mt-3 checkout-whatsapp-consent<?php echo !$codWhatsappConsentRequiredInitially ? ' u-hidden' : ''; ?><?php echo isset($errors['cod_whatsapp_consent']) ? ' is-invalid' : ''; ?>" id="cod_whatsapp_consent_wrap">
                                        <input class="ui-check__input<?php echo isset($errors['cod_whatsapp_consent']) ? ' is-invalid' : ''; ?>" type="checkbox" name="cod_whatsapp_consent" id="cod_whatsapp_consent" value="1" <?php echo $codWhatsappConsentChecked ? 'checked' : ''; ?> <?php echo $codWhatsappConsentRequiredInitially ? 'required aria-required="true"' : 'aria-required="false"'; ?>>
                                        <label class="ui-check__label u-text-small" for="cod_whatsapp_consent">
                                        ...
                                        <?php echo form_error($errors, 'cod_whatsapp_consent', 'ui-field-error'); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <label class="checkout-pay-option" for="payment_razorpay" data-pay-option="razorpay">
                                <span class="checkout-pay-main">
                                    <input class="ui-check__input u-mt-0" type="radio" name="payment_method" id="payment_razorpay" value="razorpay" <?php echo ($old['payment_method'] ?? '') === 'razorpay' ? 'checked' : ''; ?>>
                                    <span>
                                        <strong>Pay Online (Razorpay)</strong>
                                        <small class="u-block u-text-muted">
                            ...
                            <div class="checkout-pay-panel" id="razorpay-panel">
                                ...
                                <noscript>
                                    <div class="u-mb-3">
                                        <label class="ui-label u-mb-1" for="online_method_noscript">Online payment type</label>
                                        <select class="ui-select" id="online_method_noscript" name="online_method">
                                ...
                                <div class="checkout-online-panels">
                                    <div class="checkout-online-panel is-active" data-online-panel="upi">
                                        <div class="u-text-small u-text-muted u-mb-2">Pay instantly with any UPI app in secure Razorpay checkout.</div>
                                    ...
                                    <div class="checkout-online-panel" data-online-panel="card">
                                        <div class="u-text-small u-text-muted u-mb-2">Domestic and international cards are supported.</div>
                                        <div class="checkout-brand-chips">
                                    ...
                                    <div class="checkout-online-panel" data-online-panel="emi">
                                        <div class="u-text-small u-text-muted u-mb-2">No-cost/standard EMI options shown based on card and bank eligibility.</div>
                                        <div class="checkout-brand-chips">
                    ...
                    <?php if ($isIndia): ?>
                        <div id="checkout_review_section" class="<?php echo $hasCompleteDelivery ? '' : 'u-hidden'; ?>" aria-hidden="<?php echo $hasCompleteDelivery ? 'false' : 'true'; ?>">
                        <div class="u-text-small u-text-muted u-mb-2">Step 3 of 3: Review</div><button type="submit" id="checkout_submit" class="ui-button ui-button--primary ui-button--large u-w-full"><?php echo $selectedPayment === 'cod' ? 'Place COD Order — ' : 'Pay Securely — '; ?><?php echo e(money($totalAmount, 'INR', true)); ?></button>
                        <div class="trust-badge-block u-mt-3 u-mb-2" aria-label="Checkout trust badges">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($internationalQuoteUrl); ?>" class="ui-button ui-button--primary ui-button--large u-w-full">Request International Quote</a>
                    <?php endif; ?>
                </form>
            </div>

            <div class="l-col-lg-five checkout-summary-column">
                <div class="surface-panel u-p-4 checkout-summary-sticky">
                    <h5 class="u-mb-3">Order Summary</h5>
                    <?php foreach ($items as $item): ?>
                        <div class="u-flex u-justify-between u-mb-2 u-text-small">
                            <div>
                                <span class="u-font-semibold"><?php echo e($item['name']); ?></span>
                                <?php if ($item['unit_type'] === 'meter' && !empty($item['meter_length']) && !empty($item['bundle_quantity'])): ?>
                                    <span class="u-text-muted"> - <?php echo e((string) $item['bundle_quantity']); ?> x <?php echo e(format_meter_quantity((float) $item['meter_length'])); ?>m = <?php echo e($item['quantity_text']); ?>m</span>
                                <?php else: ?>
                                    <span class="u-text-muted"> - <?php echo e($item['quantity_text']); ?> <?php echo e($item['quantity_unit_label']); ?></span>
                                    <?php if ($item['unit_type'] === 'set' && (int) ($item['units_per_set'] ?? 0) > 0): ?>
                                        <span class="u-text-muted"> (<?php echo (int) $item['quantity']; ?> sets x <?php echo (int) $item['units_per_set']; ?> = <?php echo (int) $item['quantity'] * (int) $item['units_per_set']; ?> pieces)</span>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if ($item['selected_size'] !== ''): ?>
                                    <span class="u-text-muted"> (<?php echo e($item['selected_size']); ?>)</span>
                                <?php endif; ?>
                            </div>
                    ...
                    <form method="POST" action="/apply-coupon.php" class="u-mb-3" data-preserve-checkout-state>
                        <?php echo csrf_field(); ?>
                    ...
                    <form method="POST" action="/remove-coupon.php" class="u-mb-2" data-preserve-checkout-state>
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="redirect_to" value="checkout">
                        <input type="hidden" name="shipping_address_id" value="<?php echo (int) ($old['shipping_address_id'] ?? 0); ?>">
                        <div class="u-flex u-justify-between u-text-small">
                            <span>Coupon: <strong><?php echo e($couponInfo['code']); ?></strong></span>
                            <button type="submit" class="ui-button ui-button--link ui-button--small u-p-0 u-text-danger">Remove</button>
                        </div>
                    </form>
                    <?php endif; ?>
                    ...
                    <hr>
                    <?php if ($couponInfo['valid']): ?>
                    <div class="u-flex u-justify-between u-mb-1 u-text-small">
                        <span>Coupon (<?php echo e($couponInfo['code']); ?>)</span>
                        <span class="u-text-success">Applied</span>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="u-flex u-justify-between u-mb-1">
                        <span>Discount</span>
                        <span class="u-text-success" id="summary_discount">- <?php echo e(money($discountAmount)); ?></span>
                    </div>
                    ...
                    <div class="u-flex u-justify-between u-font-bold u-mt-2 u-pt-2 u-border-top">
                        <span>Total</span>
                        <span id="summary_total" data-checkout-payable><?php echo e(money($totalAmount)); ?></span>
                    </div>
                    <div class="ui-alert ui-alert--neutral u-border u-text-small u-mt-3 u-mb-0 checkout-summary-note" id="summary_shipping_note">
                        ...
                        <div id="checkout_mobile_review_section" class="checkout-mobile-review u-hide-desktop u-mt-3<?php echo $hasCompleteDelivery ? '' : ' u-hidden'; ?>" aria-hidden="<?php echo $hasCompleteDelivery ? 'false' : 'true'; ?>">
                            ...
                            <button type="submit" form="checkout_form" id="mobile_place_order_btn" class="ui-button ui-button--primary ui-button--large u-w-full">
