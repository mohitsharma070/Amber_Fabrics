...
<div class="print-bar document-toolbar">
    <a href="/customer/order-view?id=<?php echo (int) $order['id']; ?>" class="ui-button ui-button--secondary">&larr; Back to Order</a>
...
<div class="invoice-wrapper" id="invoice-document" data-document-sheet>
    ...
    <table class="inv-table">
        ...
        <tr>
            ...
            <td class="document-number"><?php echo e(money($unitPrice, (string) $order['currency'])); ?></td>
            ...
            ?></td>
            <td class="document-number"><?php echo $itemDiscount > 0 ? e(money($itemDiscount, (string) $order['currency'])) : '-'; ?></td>
            <td class="document-number"><?php echo e(money($itemAmount, (string) $order['currency'])); ?></td>
            ...
            <td class="document-number"><?php echo e(money($itemTotal, (string) $order['currency'])); ?></td>
        </tr>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
            <tr class="document-total-row">
                ...
                <td><?php echo e(money($subtotal, (string) $order['currency'])); ?></td>
            </tr>
            <?php if ($discount > 0): ?>
            <tr class="document-total-row">
                <td colspan="7">Discount</td>
                <td class="document-discount">- <?php echo e(money($discount, (string) $order['currency'])); ?></td>
            </tr>
            <?php endif; ?>
            <?php if ($taxType !== 'none' && $gstInclTotal > 0): ?>
            <tr class="document-total-row">
                <td colspan="7">Total Before Tax</td>
                <td><?php echo e(money($baseNet, (string) $order['currency'])); ?></td>
            </tr>
            <?php if ($taxType === 'igst'): ?>
            <tr class="document-total-row">
                <td colspan="7">IGST (<?php echo number_format($gstRate, 1); ?>%)</td>
                <td><?php echo e(money($gstInclTotal, (string) $order['currency'])); ?></td>
            </tr>
            <?php else: ?>
            <tr class="document-total-row">
                <td colspan="7">CGST (<?php echo number_format($gstRate / 2, 1); ?>%)</td>
                <td><?php echo e(money($cgstIncl, (string) $order['currency'])); ?></td>
            </tr>
            <tr class="document-total-row">
                <td colspan="7">SGST (<?php echo number_format($gstRate / 2, 1); ?>%)</td>
                <td><?php echo e(money($sgstIncl, (string) $order['currency'])); ?></td>
            </tr>
            <?php endif; ?>
            <tr class="document-total-row">
            ...
            <tr class="document-total-row">
                ...
                <td><?php echo e(money($shippingCost, (string) $order['currency'])); ?></td>
            </tr>
            <?php endif; ?>
            <tr class="document-grand-total">
                ...
                <td>
                    ...
                    <small>Incl. GST <?php echo e(money($gstInclTotal, (string) $order['currency'])); ?></small>
                </td>
            </tr>
        </tfoot>
    </table>
