...
$metaTitle = SiteContext::title('Terms & Conditions');
$heroSubtitle = (string) ($siteSettings['terms_policy_subtitle'] ?? ('Terms governing purchases and inquiries on ' . SiteContext::name() . '.'));
$heroSubtitle = strtr($heroSubtitle, ['{{site_name}}' => SiteContext::name(), '{{contact_email}}' => SiteContext::contactEmail()]);
$policyBody = (string) ($siteSettings['terms_policy_body_html'] ?? '');
