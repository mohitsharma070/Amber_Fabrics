...
$metaTitle = SiteContext::title('Size & Fabric Guide');
$heroSubtitle = (string) ($siteSettings['size_guide_subtitle'] ?? 'Quick reference for sizing, fabric selection, and textile care.');
